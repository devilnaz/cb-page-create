  ...
  for (let head of headAll) {
    head.addEventListener('click', function() {
      ...
      if (body.style.minHeight) {
        ...
        this.querySelector('img').setAttribute('src', '/img/modules/accordion/accordion_plus.svg');
      } else {
        bodyAll.forEach(function(body) {
          body.style.minHeight = null;
        });
        headAll.forEach(function(head) {
          ...
          head.querySelector('img').setAttribute('src', '/img/modules/accordion/accordion_plus.svg');
        });
        this.querySelector('img').setAttribute('src', '/img/modules/accordion/accordion_minus.svg');
